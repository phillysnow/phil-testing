...
export default class OverviewDCI extends Vue {
	async asyncData({ $prismic, params, error }) {
		try {
			const data = await $prismic.api.getSingle('overview_dci', {
			...
			return {
				hero: {
					// title required
					type: 'data_en_customer_intelligence',
	...
	mounted() {
		...
		this.$store.commit('SET_PARENTROUTE', '/services/expertises/data-en-customer-intelligence');
	}
}
</script>
<style lang="scss">
