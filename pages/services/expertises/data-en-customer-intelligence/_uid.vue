...
export default class ExpertiseDCI extends Vue {
	async asyncData({ $prismic, params, error }) {
		try {
			const data = await $prismic.api.getByUID('expertise_dci', params.uid, {
				fetchLinks: ['expertise_dci.page_title', 'expertise_dci.page_subtitle'],
			});
	...
	mounted() {
		...
		this.$store.commit('SET_PARENTROUTEFALLBACK', '/services/expertises/data-en-customer-intelligence');
	}
